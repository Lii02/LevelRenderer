// "wall_windowE.h" generated by "Obj2Header.exe" [Version 1.9d] Author: L.Norri Fullsail University.
// Data is converted to left-handed coordinate system and UV data is V flipped for Direct3D/Vulkan.
// The companion file "wall_windowE.h2b" is a binary dump of this format(-padding) for more flexibility.
// Loading *.h2b: read version, sizes, handle strings(max len 260) by reading until null-terminated.
/***********************/
/*  Generator version  */
/***********************/
#ifndef _wall_windowE_version_
const char wall_windowE_version[4] = { '0','1','9','d' };
#define _wall_windowE_version_
#endif
/************************************************/
/*  This section contains the model's size data */
/************************************************/
#ifndef _wall_windowE_vertexcount_
const unsigned wall_windowE_vertexcount = 47;
#define _wall_windowE_vertexcount_
#endif
#ifndef _wall_windowE_indexcount_
const unsigned wall_windowE_indexcount = 96;
#define _wall_windowE_indexcount_
#endif
#ifndef _wall_windowE_materialcount_
const unsigned wall_windowE_materialcount = 4; // can be used for batched draws
#define _wall_windowE_materialcount_
#endif
#ifndef _wall_windowE_meshcount_
const unsigned wall_windowE_meshcount = 4;
#define _wall_windowE_meshcount_
#endif
/************************************************/
...
#define __OBJ_VERT__
#endif
#ifndef _wall_windowE_vertices_
// Raw Vertex Data follows: Positions, Texture Coordinates and Normals.
const OBJ_VERT wall_windowE_vertices[47] =
{
...
#define _wall_windowE_vertices_
#endif
#ifndef _wall_windowE_indices_
// Index Data follows: Sequential by mesh, Every Three Indices == One Triangle.
const unsigned int wall_windowE_indices[96] =
{
	 0, 1, 2,
	 2, 3, 0,
	 2, 4, 3,
...
#endif
#ifndef _wall_windowE_materials_
// Material Data follows: pulled from a .mtl file of the same name if present.
const OBJ_MATERIAL wall_windowE_materials[4] =
{
	{
...
#define _wall_windowE_materials_
#endif
/************************************************/
/*  This section contains the model's structure */
/************************************************/
#ifndef _wall_windowE_batches_
// Use this conveinence array to batch render all geometry by like material.
// Each entry corresponds to the same entry in the materials array above.
// The two numbers provided are the IndexCount and the IndexOffset into the indices array.
// If you need more fine grained control(ex: for transformations) use the OBJ_MESH data below.
const unsigned int wall_windowE_batches[4][2] =
{
	{ 48, 0 },
	{ 24, 48 },
	{ 18, 72 },
...
#define __OBJ_MESH__
#endif
#ifndef _wall_windowE_meshes_
// Mesh Data follows: Meshes are .obj groups sorted & split by material.
// Meshes are provided in sequential order, sorted by material first and name second.
const OBJ_MESH wall_windowE_meshes[4] =
{
	{
		"wall_windowE",
		48,
